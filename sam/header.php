          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="header_inner">
                ...
                <a class="navbar-brand logo clearfix cuslogo" href="index"><img src="images/products/logosam.png" class="img-responsive" style="width: 75%;" ></a>
                ...
                <div class="collapse navbar-collapse" id="main-nav"><span class="navbar-header"></span>
                  <ul class="nav navbar-nav navigation">
                    ...
                    <li  class="dropdown">
                      <a target="_blank" href="login"></span>Wallet</a>
                      <ul class="dropdown-menu">
                        <li><a target="_blank" href="login">Swift (E-Wallet)</a></li>
                      </ul>
