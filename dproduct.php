  ...
  .qbtn{
    color:#000;
      ...
      <div class="col-md-4">
                ...
                <button type="submit" name="addcart" style="width: 100%; color: #fff" class="btn pbtn bgcolor" value="<?php echo $id ?>"> Order Now </button>
      </div>
    </form>
</div>
...
<br>
  ...
  <div class="col-md-3">
    ...
    $rows =mysqli_query($con,"SELECT * FROM product  ORDER BY RAND() LIMIT 5" ) or die(mysqli_error($con));
    $n=0;
